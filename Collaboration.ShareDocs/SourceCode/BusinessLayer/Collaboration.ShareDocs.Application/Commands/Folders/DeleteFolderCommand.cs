...
{
    public class DeleteFolderCommand:IRequest<ApiResponseDetails>
    {
        public Guid FolderId { get; set; }

        public class Handler : IRequestHandler<DeleteFolderCommand, ApiResponseDetails>
        {
            ...
            public async Task<ApiResponseDetails> Handle(DeleteFolderCommand request, CancellationToken cancellationToken)
            {
